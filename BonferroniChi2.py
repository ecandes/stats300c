...
class Test:
    ...
    def print_info(self,mu):
        print('Value of Bonferroni Threshold: {:.2f}'.format(self.thresh['Bonferroni']))
        print('Value of theta = ||mu||^2/sqrt(2n): {:.2f}'.format(self.theta(mu)))
        print('Expected power of chi-sq test: {:.2f}'.format(norm.cdf(self.theta(mu) - 1.645)))
